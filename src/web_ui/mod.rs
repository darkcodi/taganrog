...
pub async fn serve(config: AppConfig, client: TaganrogClient<FileStorage>) {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![choose_files, load_media_from_file, has_thumbnail, save_thumbnail, add_tag_to_media, remove_tag_from_media, delete_media, autocomplete_tags, parse_tags, show_err_dialog, show_info_dialog])
        .setup(move |app| {
